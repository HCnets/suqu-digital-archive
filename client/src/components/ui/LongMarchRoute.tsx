...
const STAGES: Stage[] = [
  ...
  { year: 1927, title: '南昌起义', location: '江西南昌', description: '8月1日，周恩来、贺龙、叶挺、朱德、刘伯承等领导南昌起义，打响了武装反抗国民党反动派的第一枪，标志着中国共产党独立领导革命战争、创建人民军队的开端。' },
  { year: 1927, title: '秋收起义', location: '湖南浏阳', description: '9月，毛泽东在湘赣边界领导秋收起义，第一次打出"工农革命军"旗帜。起义受挫后转向井冈山，开辟了农村包围城市的革命道路。' },
  { year: 1928, title: '井冈山会师', location: '江西井冈山', description: '4月，朱德、陈毅率南昌起义余部和湘南农军到达井冈山，与毛泽东领导的秋收起义部队会师，合编为红四军，奠定了中央苏区的基础。' },
  { year: 1929, title: '古田会议', location: '福建上杭古田', description: '12月，红四军第九次党代会在古田召开，确立了"思想建党、政治建军"的原则，从根本上解决了如何把一支以农民为主的军队建设成无产阶级新型人民军队的问题。' },
  { year: 1935, title: '强渡大渡河·飞夺泸定桥', location: '四川泸定', description: '5月，红军先头部队在安顺场强渡大渡河，随后飞夺泸定桥，粉碎了蒋介石让红军成为"石达开第二"的企图。' },
]
