...
const QUESTIONS: Question[] = [
  ...
  { q: '"江山就是人民，人民就是江山"出自？', options: ['毛泽东《为人民服务》', '习近平在庆祝中国共产党成立100周年大会上讲话', '邓小平南方谈话', '江泽民"三个代表"'], answer: 1, explanation: '2021年7月1日，习近平总书记在庆祝中国共产党成立100周年大会上庄严宣告："江山就是人民，人民就是江山，打江山、守江山，守的是人民的心。"' },
  { q: '澎湃创作的农民运动歌谣叫什么？', options: ['十送红军', '田仔骂田公', '映山红', '南泥湾'], answer: 1, explanation: '1923年澎湃创作了《田仔骂田公》，这是中国最早用当地方言创作的农民运动革命歌谣之一。' },
  { q: '黄木生烈士是怎么牺牲的？', options: ['病逝', '中弹牺牲', '拉响手榴弹与敌同归于尽', '在狱中被杀害'], answer: 2, explanation: '红四师战士黄木生在弹药耗尽后，拉响最后一颗手榴弹与敌人同归于尽。' },
